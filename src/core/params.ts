...
export const PARAM_DEFS = [
  ...
  { key: 'punchDownFrac', label: '아래 방향 비율 (넘으면 빠른 속도 요구)', group: '펀치 검출', min: 0, max: 1, step: 0.01, default: 0.3, unit: '' },
  { key: 'lowFpsSpeedScale', label: '15fps일 때 속도 기준 배율', group: '펀치 검출', min: 0.5, max: 1, step: 0.01, default: 0.75, unit: '' },
  ...
  { key: 'punchMaxRiseMs', label: '최대 뻗는 데 걸린 시간', group: '펀치 검출', min: 50, max: 1000, step: 10, default: 480, unit: 'ms' },
